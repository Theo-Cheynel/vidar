...
class KinetixDataset(BaseDataset):
    """
    Kinetix dataset class
    ...
    def __init__(self, split, tag=None,
        ...
        self.tag = 'kinetix' if tag is None else tag
        ...
        # No left/right cameras in the Kinetix dataset
    ...
    def _get_keypoints(filename, size):
        ...
        TODO : Figure out what is a keypoint
        """
        filename = filename. \
...
########################################################################################################################
    ...
    def __getitem__(self, idx):
        ...
        # ===== NO POSE, NO DEPTH, NO DEPTH INPUT ===== #
        # Pose = Where the camera is placed relative to the world ?
